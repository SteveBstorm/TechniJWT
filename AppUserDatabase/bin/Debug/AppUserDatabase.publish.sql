/*
Script de déploiement pour TechniJWTDemo
...
GO
:setvar DatabaseName "TechniJWTDemo"
:setvar DefaultFilePrefix "TechniJWTDemo"
...
GO
PRINT N'Création de Table [dbo].[AppUser]...';
...
GO
PRINT N'Création de Contrainte par défaut contrainte sans nom sur [dbo].[AppUser]...';
...
AS 
	...
	END
GO
PRINT N'Création de Procédure [dbo].[UserPasswordUpdate]...';
...
EXEC UserRegister 'test@test.com', 'test1234', 0
EXEC UserRegister 'admin@test.com', 'test1234', 1
GO
